...
import AiIcon from "../../assets/img/aiicon.svg"
function Chat() {
...
const handleTextChange = (e) => {
  ...
  return (
    <div className="">
      <div
        className={`fixed pt-16 top-0  h-screen w-[280px] bg-siteDarkGey dark:bg-gray-950 border-r border-gray-200 dark:border-gray-800 flex flex-col transition-all duration-300 ${
      ...
      <div
        className={`pt-20  pl-[295px] flex flex-col transition-all duration-300 ${
          isOpen ? "" : "]"
        }`}
      >
        <div className="flex flex-col items-center justify-center my-auto h-[calc(100vh-200px)]">
          <div className="w-[80%] md:w-[600px]">
            <div className="text-center mb-5 md:mb-10 flex mx-auto items-center justify-center"><img src={AiIcon} alt="ai icon"/></div>
           <div className="text-xl mb-3 text-center">Welcome to Leaflow Assistance chat</div>
          ...
          <p className="mt-3 text-xs text-center text-gray-500 dark:text-gray-400">
            Leaflow © copyright 2025 - All rights reserved
          </p>
        </div>
      </div>
    </div>
